...
def test_clean_text_scores_high():
    """
    حُدِّث بعد النسخة 1.3.0 من الإشارات.

    كان يتوقع 0.95 فأعلى. لكن المقياس صار يخفض قليلاً على الترقيم
    المنفصل (" : " هنا) لأنه علامة تقطيع في مخرجات OCR. النص بلا
    ترقيم منفصل ينال 0.99، وبه 0.94 — والفرق مقصود لا انحدار،
    فبدونه كان المقياس يتشبّع عند 1.00 ويصير ثنائياً.
    """
    assert ocr_quality("قال رسول الله الماء يطهر ولا يطهر") >= 0.95
    assert ocr_quality("قال رسول الله : الماء يطهر ولا يطهر") >= 0.9
