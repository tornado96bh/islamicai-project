...
OPTIONAL = [
    ...
    ("engines.graph.knowledge_graph", ["KnowledgeGraph", "NodeType", "EdgeType"]),
    ("engines.ontology.concepts", ["Ontology"]),
    ("engines.reasoning.temporal", ["TemporalReasoner", "Lifespan"]),
    ("engines.reasoning.contradiction", ["ContradictionEngine"]),
    ("engines.fiqh.reasoner", ["FiqhReasoner"]),
    ("engines.ranking.reranker_v2", ["CrossEncoderReranker", "LearningToRank",
